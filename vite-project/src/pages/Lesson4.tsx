  ...
  return (
    <div className='container-video'>
      ...
      <div className='vdo-les'>
        {id === '1' ? <ReactPlayer url='https://www.youtube.com/watch?v=yHFcNNh-SsA' controls width="100%" height="100%"/> : null}
        {id === '2' ? <ReactPlayer url='https://www.youtube.com/watch?v=TOkU5HxES1o' controls width="100%" height="100%"/> : null}
        {id === '3' ? <ReactPlayer url='https://www.youtube.com/watch?v=WvHr-yGnGPw' controls width="100%" height="100%"/> : null}
        {id === '4' ? <ReactPlayer url='https://www.youtube.com/watch?v=NVyOEwOJgNQ' controls width="100%" height="100%"/> : null}
      </div>
