...
const CourseData: React.FC<CourseDataProps> = () => {
  ...
  const [completed, setCompleted] = useState<boolean[]>(() => {
    const storedData = localStorage.getItem('completedData');
          ...
          <div className='box-cou'>
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>What is R</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Choose R for Data Science</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Features of R for Data Science</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>R Suitable For Data Science</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Data Science Companies that Use R</p>
              </div>
