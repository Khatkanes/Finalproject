...
interface CoursephtonProps {
  courses: Course | null;
}

const Coursephton: React.FC<CoursephtonProps> = () => {
  const { id } = useParams<{ id: string }>();
  const [completed, setCompleted] = useState<boolean[]>(() => {
    const storedData = localStorage.getItem('completedPhton');
    return storedData ? JSON.parse(storedData) : [false, false, false, false, false];
  });

  useEffect(() => {
    localStorage.setItem('completedPhton', JSON.stringify(completed));
  }, [completed]);
  ...
  const clearLocalStorage = () => {
    localStorage.removeItem('completedPhton');
  };
          ...
          <div className='box-cou'>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Python Syntax</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Python Comments</p>
              </div>
            ...
            <div className='bg-cou'>
              <div className='cou-coutent'>
                ...
                <p className='text-cou'>Python Variables</p>
              </div >
